...
<div class="row clearfix">
    ...
    <div class="col-sm-6">
        <div class="card">
            ...
            {!! Form::open(['url' => 'admin/booking/place_order', 'class' => 'form-validation', 'id'=> 'bookingFrm']) !!} 
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content ">
            ...
            <div class="modal-body">
                ...
                {!! Form::open(['url' => 'admin/booking/createClient', 'class' => 'form-validation', 'files' => true, 'id'=>'frmClient']) !!}
                <div class="row">
                    <div class="col-sm-6">
...
{  
    ...
    */
    ...
    $('#priceListModal').on('show.bs.modal', function (event) 
    {
        ...
        {
            $.ajax({
                url: '{{ URL::to("admin/booking/getPriceList") }}',
                type: 'post',
                dataType: 'json', 
                data:{place_id: id},
    ...
    */
    ...
    { 
        ...
        {   
            //ajax call
            $.ajax({
                url: '{{ URL::to("admin/booking/findScheduleAndPrice") }}',
                type: 'post',
                dataType: 'json', 
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                data: {
    ...
    */ 
    ...
    { 
        $.ajax({
            url: '{{ URL::to("admin/booking/getDiscount") }}',
            type: 'post',
            dataType: 'json', 
            headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
            data: { 
    ...
    */
    $("#client_id_no").on('keyup change', function(e){
        ...
        {  
            $.ajax({
                url: '{{ URL::to("admin/booking/checkClientID") }}',
                type: 'post',
                dataType: 'json', 
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                data: { 
    ...
    */
    $('body').on("change", ".bookingPeriod", function(){
        ...
        $.ajax({
            url: '{{ url("admin/booking/getZoneAndVehicleWisePriceList") }}',
            // dataType: 'json',
            type    : 'post',
            data    : {
                place_id: $("#place_id").val(),
